...
```json
"depencies": {
  "@whiskeysockets/baileys": "github:ahmadcihuy/bail"
}
```
## Import
```javascript
...
await client.relayMessage(m.chat, {
  productMessage {
    ...
    url: "https://t.me/AhmadXst",
    body: "Nak Tido",
    footer: "Footer",
    buttons: [
      {
        name: "cta_url",
        buttonParamsJson: "{\"display_text\":\"kayzen\",\"url\":\"https://t.me/ahmadcihuy\"}"
      }
    ],
